...
# generate_product_exe_version() function
#
# This function uses Windows-MyExeVersionInfo.in template file and Windows-MyVersionResource.rc file
# to generate WIN32 resource with version information and general resource strings.
#
# Usage:
#   generate_product_exe_version (
...
function (generate_product_exe_version outfiles)
    set (options)
    set (oneValueArgs
        NAME
        BUNDLE
    ...
    string (MD5 _VersionDigest "${PRODUCT_BUNDLE}_${PRODUCT_NAME}_${PRODUCT_VERSION}_${PRODUCT_ICON}")
    set (_VersionInfoFile ${CMAKE_CURRENT_BINARY_DIR}/rc.${_VersionDigest}/Windows-MyExeVersionInfo.h)
    set (_VersionResourceFile ${CMAKE_CURRENT_BINARY_DIR}/rc.${_VersionDigest}/Windows-MyExeVersionResource.rc)
    configure_file (
        ${GenerateProductVersionCurrentDir}/Windows-MyExeVersionInfo.in
        ${_VersionInfoFile}
        @ONLY)
    configure_file (
        ${GenerateProductVersionCurrentDir}/Windows-MyExeVersionResource.rc
